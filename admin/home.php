            ...
            <div class="card">
                ...
                <div class="card-footer text-center">
                    ...
                    if (mysqli_num_rows($ceksuka) == 1) { ?>
                        <a href="../config/proses_like.php?foto_id=<?php echo $data['foto_id'] ?>" type="submit" name="batal_suka"><i class="fa fa-heart"></i></a>
                    <?php }else{ ?>
                    ...
                    <?php
                    $jmlkomen = mysqli_query($koneksi, "SELECT * FROM kometar_foto WHERE foto_id='$foto_id'");
          ...
          <div class="col-md-4">
            <div class="m-2">
              <div class="overflow-auto">
                ...
                <hr>
                <p align="left">
                  <?php echo $data['dekripsi_foto'] ?>
                </p>
                <hr>
                <?php
                $foto_id = $data['foto_id'];
                $komentar = mysqli_query($koneksi,"SELECT * FROM kometar_foto INNER JOIN user ON kometar_foto.user_id=user.user_id WHERE kometar_foto.foto_id='$foto_id'");
